...
def score_document(name: str, content: str, file_class: str = "document") -> dict:
    ...
    if document_shaped: chapter("metadata", "元数据完整性", 5, [
    ...
    if document_shaped: chapter("abstract", "摘要质量", 2, [
    ...
    for i, heading in enumerate(headings):
        try:
            ...
            intro_missing += 1
    if document_shaped: chapter("structure", "结构完整性", 10, [
    ...
    if document_shaped: chapter("retrieval", "可检索性", 5, [
    ...
    if document_shaped: chapter("rag", "RAG 优化", 3, [
